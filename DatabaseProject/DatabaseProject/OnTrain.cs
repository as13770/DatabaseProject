...
namespace DatabaseProject
{
    public partial class OnTrain : Form
    {
        ...
        {
            {
                ...
                {
                    AddStatus.Text = "";
                    String query = "INSERT INTO " + tableName + " ([trainid], [versionid]) ";
                    query += "VALUES (@trainid, @versionid);";
        ...
        private void OnTrain_FormClosed(object sender, FormClosedEventArgs e) //Application will not close on its own without this
        {
            Application.Exit();
        }
    }
